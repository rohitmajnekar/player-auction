    ...
    useEffect(() => {
        ...
        function shootStream(startX, startY, dirX, dirY, color) {
            ...
            const interval = setInterval(() => {
                ...
                // Strong focused velocity
                const velocityX = dirX * 1500;
                const velocityY = dirY * 1500;
        ...
        // extracard.innerText = 1

        // const manycounter = setInterval(() => {
        //     extracard.innerText = parseInt(splatterDiv.innerText) + 1
        //     if (parseInt(splatterDiv.innerText) === 30){
        //         const rect = splatterDiv.getBoundingClientRect();

        //         // RIGHT SIDE -> LEFT THROW
        ...
        //     }
        // },1000);
        // splatterDiv.addEventListener("click", () => {
        ...
        function createBorderSplat(x, y, dx, dy, delay = 0) {
            setTimeout(() => {
                const color = generateColor();
                ...
                // Strong throw
                const randomForceX = dx  * (Math.random() - 0.5);
                const randomForceY = dy  * (Math.random() - 0.5);
        ...
        const splatterDivs = document.querySelectorAll(".splatterer");

        splatterDivs.forEach((splatterDiv) => {

            splatterDiv.addEventListener("click", handleClick);

            function handleClick() {
                console.log("Splatterer clicked!");
                const rect =
                    splatterDiv.getBoundingClientRect();
